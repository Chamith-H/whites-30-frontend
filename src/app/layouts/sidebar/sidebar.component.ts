...
import { EventService } from "../../core/services/shared/event.service";
...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  //!--> Refresh local permissions | with backend live changes.....................................|
  refreshPermissions() {
    this.socketService.refreshPermissions(
      (data: RefreshPermissionInterface) => {
        const isReLocate = this.accessControlService.reload(data);
  ...
  //!--> Refresh local user | with backend live changes............................................|
  refreshUser() {
    this.socketService.refreshUser((data: RefreshUserInterface) => {
      const updateResponse = this.authenticationService.refreshUser(data);
  ...
  //!--> Refresh local role | with backend live changes............................................|
  refreshRole() {
    this.socketService.refreshRole((data: RefreshRoleInterface) => {
      const updateResponse = this.authenticationService.refreshRole(data);
